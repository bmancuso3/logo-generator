...
// Circle test
test('Circle test - it should create a red circle with a white CC inside', () => {
...
// Square test
test('Square test - it should create a blue square with an orange DEN inside', () => {
...
//Triangle test
test('Triangle test - it should create a green triangle with a yellow RH inside', () => {
